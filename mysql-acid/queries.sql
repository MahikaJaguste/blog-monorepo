...
-- for blog print
select THREAD_ID, OBJECT_NAME, INDEX_NAME, LOCK_TYPE, LOCK_MODE, LOCK_DATA, LOCK_STATUS FROM performance_schema.data_locks;

CREATE UNIQUE INDEX idx_tuple ON points(player_id,game_id);